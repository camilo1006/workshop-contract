namespace ContractTest.ContractConsumerTest
{
    ...
    public class FoodPreservationConsumerBase : IDisposable
    {
        ...
        {
            var pathDir = $"..{Path.DirectorySeparatorChar}..{Path.DirectorySeparatorChar}..{Path.DirectorySeparatorChar}pacts";
            ...
            PactBuilder
                .ServiceConsumer("FoodPreservation")
                .HasPactWith("Inventory");
